...
namespace VasimR.Parallax
{
    ...
    class ParallaxManager : IGamefied
    {
        ...
        public void LoadContent(Microsoft.Xna.Framework.Graphics.GraphicsDevice device, SpriteBatch spriteBatch)
        {
            ...
            backgroundA = new ScrollingPane(this.Background, new Vector2(0, 0), new Vector2(1782, 600), 1); // [ X ][  ] First Sprite
            backgroundB = new ScrollingPane(this.Background, new Vector2(1782, 0), new Vector2(1782, 600), 1); // [  ][ X ] Second Sprite
            starfieldA = new ScrollingPane(this.Starfield, new Vector2(0, 0), new Vector2(800, 600), 4); // [ X ][  ] First Sprite
            starfieldB = new ScrollingPane(this.Starfield, new Vector2(800, 0), new Vector2(800, 600), 4); // [  ][ X ] Second Sprite
